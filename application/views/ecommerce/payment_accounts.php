                ...
                <div class="card">
                  ...
                  <div class="card-footer p-3" style="border:1px solid #e4e6fc">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for=""><?php echo $this->lang->line("Moncashpay Client ID"); ?> </label>
                                <input name="moncashpay_client_id" value="<?php echo isset($xvalue['moncashpay_client_id']) ? $xvalue['moncashpay_client_id'] : ""; ?>" class="form-control" type="text">
                                <span class="red"><?php echo form_error('moncashpay_client_id'); ?></span>
                            </div>
                        </div>

                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for=""><?php echo $this->lang->line("Moncashpay Secret ID"); ?> </label>
                                <input name="moncashpay_secret_id" value="<?php echo isset($xvalue['moncashpay_secret_id']) ? $xvalue['moncashpay_secret_id'] : ""; ?>" class="form-control" type="text">
                                <span class="red"><?php echo form_error('moncashpay_secret_id'); ?></span>
                            </div>
                        </div>

                        <div class="col-12 col-md-4">
                          <div class="form-group">
                            <label for=""><?php echo $this->lang->line('Moncash Sandbox Mode'); ?></label>
                            <br>
                            <?php 
                            $moncash_mode = isset($xvalue['moncash_mode']) ? $xvalue['moncash_mode'] : "";
                            if ($moncash_mode == '') $moncash_mode = 'live';
                            ?>
                            <label class="custom-switch mt-2">
                              <input type="checkbox" name="moncash_mode" value="sandbox" class="custom-switch-input" <?php if ($moncash_mode == 'sandbox') echo 'checked'; ?>>
                              <span class="custom-switch-indicator"></span>
                              <span class="custom-switch-description"><?php echo $this->lang->line('Enable'); ?></span>
                              <span class="red"><?php echo form_error('moncash_mode'); ?></span>
                            </label>
                          </div>
                        </div>
                    </div>
                      ...
                      <div class="row">
                       ...
                       <?php if($xdata2['store_type'] == 'physical') : ?>
                        ...
                        <<div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>
                              <?php echo $this->lang->line("Moncash Checkout"); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                <input type="radio" name="moncash_enabled" value="1" class="selectgroup-input" <?php if(isset($xdata2["moncash_enabled"]) && $xdata2["moncash_enabled"] == '1') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("Yes") ?></span>
                              </label>
                              <label class="selectgroup-item">
                                <input type="radio" name="moncash_enabled" value="0" class="selectgroup-input" <?php if(isset($xdata2["moncash_enabled"]) && $xdata2["moncash_enabled"] == '0') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("No") ?></span>
                              </label>
                            </div>
                          </div>
