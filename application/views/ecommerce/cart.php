<style>
  ...
  .moncash-button {
    ...
    width: 325px;
    height: 85px;
    border: 1px solid #6c757d; /* Equivalent à btn-outline-secondary */
    border-radius: 0.25rem; /* Ajoute un léger arrondi au bouton */
    cursor: pointer; /* Change le curseur au survol */
    margin-left: 30px;
    }

    .moncash-button:hover {
...
$subtotal_count = 0; // Initialiser le total
...
<div class="invoice p-0 pt-2 no_shadow bg-light">
  <?php if ($i > 0) : ?>
    <div class="invoice-print">
      <di class="section">
        <div class="section-title mt-0 mb-2"><?php echo $this->lang->line("Cart"); ?><span class="float-right"><?php echo date("jS M,Y"); ?></span></div>
      </di>
      <?php echo $table_data; ?>
      <div class="row">
...
<div class="modal fade" role="dialog" id="payment-options-modal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo site_url('payment/init_payment'); ?>" method="post">
    <input type="hidden" name="amount" value="<?php echo $checkout_amount; ?>"> <!-- Montant dynamique -->
    <button type="submit" class="moncash-button">
        <img src="https://sandbox.moncashbutton.digicelgroup.com/Moncash-middlewareTest/resources/assets/images/MC_button.png" alt="Moncash Icon" class="icon">
        Payer avec Moncash
    </button>
</form>

      <?php include(APPPATH . "views/ecommerce/common_style.php"); ?>
      <div class="modal-body" id="payment_options"></div>
